...
export const Topbar: React.FC = () => {
  const { settings, setSettings, isScanning, setShowSettings, selectedNodeId, getNodeById, skills } = useAppContext();
  ...
  return (
    <div className="h-12 border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-[#1e1e1e] flex items-center justify-between px-4 flex-shrink-0 select-none">
      {/* Left: Logo & Title */}
